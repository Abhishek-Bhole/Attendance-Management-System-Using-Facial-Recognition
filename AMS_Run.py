...
def manually_fill():
    global sb
    sb = tk.Tk()
    #sb.iconbitmap("@/home/abhishek/Downloads/Attendace_management_system-master/AMS.png")
    ...
    def err_screen_for_subject():
        ...
        ec = tk.Tk()
        ec.geometry('300x100')
       # ec.iconbitmap("@/home/abhishek/Downloads/Attendace_management_system-master/AMS.png")
        ec.title('Warning!!')
    ...
    def fill_attendance():
        ...
        if subb=='':
            ...
            sb.destroy()
            MFW = tk.Tk()
            #MFW.iconbitmap("@/home/abhishek/Downloads/Attendace_management_system-master/AMS.png")
            ...
            def err_screen1():
               ...
               # errsc2.iconbitmap('@/home/abhishek/Downloads/Attendace_management_system-master/AMS.png')
            ...
            def create_csv():
                ...
                csv_name='/home/abhishek/Downloads/Attendace_management_system-master/Attendance/Manually Attendance/'+DB_table_name+'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(r'explorer /select,"/home/abhishek/Downloads/Attendace_management_system-master\Attendance\Manually Attendance\-------Check atttendance-------"')
...
def err_screen():
    ...
    #sc1.iconbitmap('@/home/abhishek/Downloads/Attendace_management_system-master/AMS.png')
    sc1.title('Warning!!')
...
def err_screen1():
    ...
    #sc2.iconbitmap('@/home/abhishek/Downloads/Attendace_management_system-master/AMS.png')
    sc2.title('Warning!!')
...
def subjectchoose():
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                root.configure(background='snow')
                cs = '/home/abhishek/Downloads/Attendace_management_system-master/' + fileName
    ...
    windo = tk.Tk()
   # windo.iconbitmap('@/home/abhishek/Downloads/Attendace_management_system-master/AMS.png')
    ...
    def Attf():
        import subprocess
        subprocess.Popen(r'explorer /select,"/home/abhishek/Downloads/Attendace_management_system-master\Attendance\-------Check atttendance-------"')
...
def admin_panel():
    win = tk.Tk()
    #win.iconbitmap('@/home/abhishek/Downloads/Attendace_management_system-master/AMS.png')
    win.title("LogIn")
    ...
    def log_in():
        ...
        if username == 'admin' :
            if password == 'admin':
                ...
                cs = '/home/abhishek/Downloads/Attendace_management_system-master/StudentDetails/StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
...
#window.iconbitmap('@/home/abhishek/Downloads/Attendace_management_system-master/AMS.png')
